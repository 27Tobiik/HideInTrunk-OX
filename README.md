...
# Installation
1. Place the `mytrunk` folder into your `resources` folder.  
2. Add `ensure mytrunk` to your `server.cfg`.  
3. Make sure your server has **`ox_inventory`** and **`ox_lib`** installed.  
